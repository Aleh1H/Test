...
//     eldiv.setAttribute('class', 'member');
//     eldiv.innerHTML = `name: ${item.name}, surname: ${item.surname}, age: ${item.age}, info: ${item.info}, photo: ${item.photo}`;
...
//     divage.innerText = item.age;
//     divinfo.innerText = item.info;
//     divphoto.src = item.photo;
//     eldiv.append(divname, divsurname, divage, divinfo, divphoto);
//     document.body.append(eldiv);
// }
...
for (const item of coursesArray) {
    ...
    // const elementsByTagName = document.getElementsByTagName('modules');
    for (const x of item.modules) {
        const lliElement = document.createElement('li');
        lliElement.innerText = x;
        modules.append(lliElement);
    }

    DivElement.append(title, monthDuration, hourDuration, modules);
...
//     const ulclas = document.getElementsByClassName('menu')[0];
//     ulclas.append(liElement);
// }
...
//     const DivElement = document.createElement('div');
//     DivElement.innerText = `Title: ${item.title}, Duration: ${item.monthDuration}`;
//     document.body.append(DivElement);
// }
...
//     paragraphElement.setAttribute('class', 'description');
